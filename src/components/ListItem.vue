<template>
  <div class="listing__item" @click="$emit('on-click')">
    <div class="listing__cell_image">
      <img src="@/assets/icon.png" alt="Coin logo" />
    </div>
    ...
    <div class="listing__cell_price" :class="typeOfChange">
      ...
      <br />
      <span class="listing__item_additional"
...
export default {
  ...
  computed: {
    typeOfChange() {
      return this.item.quotes.USD.percent_change_1h < 0
        ? "decrease"
        : "increase";
    }
  }
